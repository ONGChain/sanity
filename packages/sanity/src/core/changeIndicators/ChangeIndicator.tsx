...
export function ChangeIndicator(
  props: ChangeIndicatorProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'disabled'>
) {
  const {children, className, disabled, hasFocus, isChanged, path, withHoverEffect, ...restProps} =
    props
  return (
    <ChangeBarWrapper
      {...restProps}
