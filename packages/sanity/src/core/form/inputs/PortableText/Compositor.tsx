...
export function Compositor(props: Omit<InputProps, 'schemaType' | 'arrayFunctions'>) {
    ...
    (blockProps: EditorBlockRenderProps) => {
      ...
      return (
        <TextBlock
          ...
          readOnly={readOnly}
          referenceBoundary={editorElement}
  ...
  const editorNode = useMemo(
    () => (
      <Editor
        ...
        scrollElement={editorElement}
        setScrollElement={setEditorElement}
      />
    ),
  ...
  useTrackFocusPath({focusPath, boundaryElement: editorElement, onItemClose})
